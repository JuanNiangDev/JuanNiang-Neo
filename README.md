...
- **示例插件库**：`data/pluggins/` 下 13 个示例插件覆盖全部插件功能，每个含 README.md
...
| 插件开发 | [plugin-development.md](docs/plugin-development.md) | 快速开始 + 完整 Lua API 参考（log/json/onebot11/http/database/cache/t2i/sandbox/agent/file/command）+ 引擎实现细节 + 常见坑；示例插件见 `data/pluggins/`（13 个，覆盖全部功能） |
