...
回复规则:
- 如果消息明确指向你（@你、叫你名字、称呼"机器人"/"bot"、询问你的能力、请求你操作），相关度应该高（>0.7）
...
上下文:
%s`, h.SelfQQ, h.SelfQQ, contextStr)
